...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            //var input = $('<input type="text" name="' + id + '" class="' + search_init + sCSSClass + '" value="' + inputvalue + '"/>');
            var input = $('<input type="text" name="' + id + '" class="' + sCSSClass + '" value="" placeholder = "' + inputvalue + '"/>');
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" name="startdate" class="date_range_filter input-small" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text"  name="enddate" class="date_range_filter input-small" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
