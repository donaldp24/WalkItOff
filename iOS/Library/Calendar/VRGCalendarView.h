...
typedef enum {
    CalendarAnimateVertical = 0,
    CalendarAnimateHorizontal = 1
}CalendarAnimateType;

#define kVRGWeekDaysTopBarHeight 30
#define kVRGCurrentLabelHeight 40
#define kVRGCalendarViewWidth 320

#define kVRGMarkTopMargin 36
#define kVRGCurrentLabelTopMargin 10
...
@property (nonatomic, assign) CalendarAnimateType animType;
