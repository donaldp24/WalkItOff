...
- (IBAction)onBtnPlus:(id)sender
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(onFavoritesCellBtnPlus:)])
        [self.delegate onFavoritesCellBtnPlus:self.food];
...
- (IBAction)onBtnMinus:(id)sender
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(onFavoritesCellBtnMinus:)])
        [self.delegate onFavoritesCellBtnMinus:self.food];
